...
# Define the synthetic random dataset
synth_rand_train_dataset = Synth_rand_Dataset(root='./data/Synthetic_Can_Data', train=True,
                                    transform=trans.Compose([
                                        trans.Resize(imsize),
                                        trans.ToTensor(),
                                        trans.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)),
...
genSC_train = Generated_Dataset(root='./data/SC_gen_data', train=True,
                              transform=trans.Compose([
                                  trans.Resize(imsize),
                                  trans.ToTensor(),
                                  trans.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)),
...
genPC_train = Generated_Dataset(root='./data/PC_gen_data', train=True,
                              transform=trans.Compose([
                                  trans.Resize(imsize),
                                  trans.ToTensor(),
                                  trans.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)),
...
data_synth_rand = np.array([synth_rand_train_dataset[i][0].numpy().flatten() for i in range(len(synth_rand_train_dataset))])
...
plt.title('PCA Visualization of Synthetic Black, Generated and Physical Datasets')
